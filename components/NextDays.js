    ...
    return (
        <View>
            {formatedData.map( (day,i) => {
                if (i==0) return
                return <View key={i} style={styleInCompo1.dayContainer} >
                    <Text style={styleInCompo1.day}>{day.day}</Text>
                    <View>
                        <Image source={{ uri: `http://openweathermap.org/img/wn/${day.data[4].weather[0].icon}@4x.png` }} style={styleInCompo1.icon}  /> 
